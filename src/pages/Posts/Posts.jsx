...
import { increasePgn, post_pagination } from "../../redux/services/ContactSlice";
        ...
        <div className="overflow-x-scroll lg:overflow-auto rounded-b-lg">
          ...
          <table className=" w-full rounded-b-lg">
            ...
            <tbody className="">
              {show_data?.map((data) => {
                return (
                  <tr key={data?.id} className="h-full  bg-white border-b">
                    <td className=" ps-10">
                    ...
                    <td className=" capitalize">{data?.author}</td>
                    <td className=" capitalize">{data?.categories}</td>

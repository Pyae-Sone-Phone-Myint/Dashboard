  ...
  return (
    <div className=" flex min-h-screen ">
      <div className="flex w-full md:flex-row flex-col">
        <div className="w-full md:w-[100%] lg:w-[25%] flex flex-col gap-10">
          ...
          <div className="  shadow-xl rounded-xl bg-white">
            ...
            <div className=" p-8">
              <div
                className=" border w-full min-h-[80px] rounded gap-2 bg-[rgba(0,0,0,0.03)] flex items-start py-2 px-2"
                
              >
                <div className=" bg-indigo-600 text-white border px-5 py-1 rounded-full">
                  Tag1
                </div>
                <div className=" bg-indigo-600 text-white border px-5 py-1 rounded-full">
                  Tag2

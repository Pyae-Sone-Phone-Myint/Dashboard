      ...
      <div className=" flex min-h-screen items-center">
        <div className="flex w-full md:flex-row flex-col py-8 px-3">
           <div className="flex-[50%]">
            <Reveal2 className="w-auto "  value={-200}>
            <div className="  flex items-center justify-center px-8  py-16">
               <div className=" shadow-2xl rounded-2xl overflow-hidden">
          
                  <h2 className=" px-12 py-7 uppercase text-[.9rem] font-normal tracking-[.2em] text-primary  shadow">
                    bubbly dashboard
                  </h2>
                  <div className=" p-12">
                    <h1 className=" text-[1.575rem] font-bold mb-6">
                      Hi, welcome back!
                    </h1>
          ...
          <div className="flex-[50%]  text-center flex flex-col items-center justify-center">
            ...
            <Reveal2>
            <img
                src="https://d19m59y37dris4.cloudfront.net/bubbly/1-3-2/img/drawkit-illustration.svg"
                alt="pig"
              />
            </Reveal2>
            </div>
            <h1 className=" text-primary text-[2.25rem] font-bold leading-10 mb-4">
              Start saving <br /> your time & money
            </h1>
            <p className=" text-[1.125rem] font-light text-[#6c757d] mb-4">
              One morning, when Gregor Samsa woke from troubled <br /> dreams,
              he found himself transformed in his bed in
            </p>
          </div>
        </div>
      </div>
